...
<!--const radioDataCenter = computed(() => store.tables.serviceTable.byId[radioService.value]?.data_center.id || '')-->
...
<!--          >-->
<!--            &lt;!&ndash;            选择group后，radioPayment应该复位为prepaid，因为新的组不一定满足postpaid条件&ndash;&gt;-->
...
<!--                {{ `${flavor.vcpus}${tc('components.server.ServerDeployCard.cores')}/${flavor.ram}GB` }}-->
<!--              </div>-->
<!--            </q-radio>-->
<!--          </div>-->
<!--        </div>-->
