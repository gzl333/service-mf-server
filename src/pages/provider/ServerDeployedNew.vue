...
<template>
  <div class="ServerDeployed">
    ...
    <div class="row">
      {{ tc('pages.ServerDeployedNew.search_condition') }}:
    </div>
    <!--项目组详情开始-->
    <div class="row items-center justify-evenly detail-area">
      ...
      <div class="col-auto row items-center">
        <q-checkbox v-model="searchFactors" val="ip" color="primary">
          {{ tc('pages.ServerDeployedNew.ip_address') }}
        </q-checkbox>
      ...
      <div class="col-auto row items-center">
        <q-checkbox v-model="searchFactors" val="username" color="primary">
          {{ tc('pages.ServerDeployedNew.user_account') }}
        </q-checkbox>
        <q-input outlined dense/>
      </div>
      ...
      <div class="col-auto row items-center">
        <q-checkbox v-model="searchFactors" val="vo" color="primary">
          {{ tc('pages.ServerDeployedNew.group_id') }}
        </q-checkbox>
        <q-input outlined dense/>
      </div>
      ...
      <div class="col-auto row items-center">
        <q-checkbox v-model="searchFactors" val="service" color="primary">
          {{ tc('pages.ServerDeployedNew.service_node') }}
        </q-checkbox>
        <q-select outlined dense stack-label :label="tc('pages.ServerDeployedNew.service_node_filter')" v-model="serviceSelection"
