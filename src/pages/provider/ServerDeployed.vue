...
const columns = [
  {
    name: 'ipv4',
    label: (() => tc('pages.ServerDeployed.ip_address'))(),
    field: 'ipv4',
    align: 'center',
  ...
  {
    name: 'service',
    label: (() => tc('pages.ServerDeployed.service_node'))(),
    field: 'service',
    align: 'center',
    style: 'padding: 15px 0px',
    headerStyle: 'padding: 0 5px'
  ...
  {
    name: 'user',
    label: (() => tc('pages.ServerDeployed.user'))(),
    field: 'user',
    align: 'center',
    style: 'padding: 15px 0px',
    headerStyle: 'padding: 0 5px'
  ...
  {
    name: 'remark',
    label: (() => tc('pages.ServerDeployed.remark'))(),
    field: 'remark',
    align: 'center',
    classes: 'ellipsis',
    style: 'padding: 15px 0px',
  ...
  {
    name: 'image',
    label: (() => tc('pages.ServerDeployed.operating_system'))(),
    field: 'image',
    align: 'center',
    style: 'padding: 15px 0px',
    headerStyle: 'padding: 0 5px'
  ...
  {
    name: 'configuration',
    label: (() => tc('pages.ServerDeployed.cpu_and_ram'))(),
    field: 'configuration',
    align: 'center',
    style: 'padding: 15px 0px',
    headerStyle: 'padding: 0 5px'
  ...
  {
    name: 'public_ip',
    label: (() => tc('pages.ServerDeployed.network_type'))(),
    field: 'public_ip',
    align: 'center',
    style: 'padding: 15px 0px',
    headerStyle: 'padding: 0 5px'
  ...
  {
    name: 'creation_time',
    label: (() => tc('pages.ServerDeployed.creation_time'))(),
    field: 'creation_time',
    align: 'center',
    style: 'padding: 15px 0px',
    headerStyle: 'padding: 0 5px'
  },
  {
    ...
    label: (() => tc('pages.ServerDeployed.expiration_time'))(),
...
const searchQuery: any = ref({
  ...
  page_size: 15,
  service_id: {
    label: (() => tc('pages.ServerDeployed.total_service'))(),
    value: ''
  },
  'as-admin': true
})
...
const options = ref([(() => tc('pages.ServerDeployed.user_id'))(), (() => tc('pages.ServerDeployed.user_account'))(), 'VOID'])
...
const search = () => {
  ...
  if (model.value === null) {
    ...
    if (model.value === (() => tc('pages.ServerDeployed.user_id'))()) {
      searchQuery.value['user-id'] = text.value
    } else if (model.value === (() => tc('pages.ServerDeployed.user_account'))()) {
  ...
  <div class="ServerDeployed">
    <div class="row q-col-gutter-md q-pb-md">
      <div class="row col-6 items-center q-col-gutter-xs">
        <div class="col-2 text-subtitle1">{{ tc('pages.ServerDeployed.search_condition') }}:</div>
        <q-select outlined dense clearable v-model="model" :options="options" :label="tc('pages.ServerDeployed.select')" class="col-5"
                  @update:model-value="change"/>
        <q-input outlined dense v-model="text" :label="tc('pages.ServerDeployed.enter')" :disable="disable" class="col-5"/>
      </div>
      <div class="col-5 row items-center">
        <q-select map-options emit-value outlined dense stack-label :label="tc('pages.ServerDeployed.service_select')" :options="filterOptions"
                  v-model="searchQuery.service_id" class="col-7" color="primary"/>
        <q-btn outline color="primary" text-color="black" :label="tc('pages.ServerDeployed.search')" class="col-3 q-ml-md" @click="search"/>
      </div>
    </div>
    <q-table
      flat
      ...
      color="primary"
      :loading-label="tc('pages.ServerDeployed.requesting')"
      :no-data-label="tc('pages.ServerDeployed.no_server')"
      hide-pagination
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td key="configuration" :props="props">
            {{ `${props.row.vcpus}tc('pages.ServerDeployed.cores')/${props.row.ram / 1024}GB` }} //
          </q-td>
          <q-td key="public_ip" :props="props">
            {{ props.row.public_ip === true ? tc('pages.ServerDeployed.public_net') : tc('pages.ServerDeployed.private_net') }} //
          </q-td>
...
<!--          <q-td key="center_quota" :props="props">-->
    ...
    <div class="row q-pa-sm text-grey justify-between items-center">
      <div class="row items-center">
        <span class="q-pr-md">{{ tc('pages.ServerDeployed.total_server') }}：{{ paginationTable.count }}</span>
        <q-select color="grey" v-model="paginationTable.rowsPerPage" :options="[5,10,15,20,25,30]" dense options-dense
                  borderless @update:model-value="changePageSize">
        </q-select>
        <span>/{{ tc('pages.ServerDeployed.page') }}</span>
      </div>
      <q-pagination
