          ...
          <div class="content-fixed-width">
            <div class="row justify-between q-pt-lg q-pb-sm">
              ...
              <div class="col-auto row items-end text-h6 q-px-none">
                {{ tc('pages.PersonalIndex.personal_resource') }}
              </div>
...
<!--                </div>-->
                ...
                <div class="col-auto column items-end">
                  <div class="text-grey q-pa-none" style="font-size: 5px;">{{ tc('pages.PersonalIndex.personal_account_balance') }}</div>
                  <div class="row items-end">
                    <div class="text-h4">{{ store.items.personalBalance.balance }}</div>
                    <div class="text-h6">{{ tc('pages.PersonalIndex.points') }}
                    </div>
                  </div>
                </div>
              ...
              <div class="col">
                ...
                >
                  <q-tab
                    ...
                    name="list"
                    icon="computer"
                    :label="tc('pages.PersonalIndex.server_list')"
                    :ripple="false"
                  ...
                  <q-tab
                    ...
                    name="order"
                    icon="list_alt"
                    :label="tc('pages.PersonalIndex.order_list')"
                    :ripple="false"
                  ...
                  <q-tab
                    ...
                    name="coupon"
                    icon="currency_yuan"
                    :label="tc('pages.PersonalIndex.coupon_list')"
                    :ripple="false"
